...
export const fetchTopVideoArticles = createAsyncThunk(
  'topVideoArticles/fetchTopVideoArticles',
  async (
...
const topVideoArticlesSlice = createSlice({
  name: 'topVideoArticles',
  initialState,
  reducers: {
    resetTopVideoArticles(state) {
      state.articles = [];
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchTopVideoArticles.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(fetchTopVideoArticles.fulfilled, (state, action) => {
      ...
      .addCase(fetchTopVideoArticles.rejected, (state, action) => {
...
export const { resetTopVideoArticles } = topVideoArticlesSlice.actions;
export default topVideoArticlesSlice.reducer;
